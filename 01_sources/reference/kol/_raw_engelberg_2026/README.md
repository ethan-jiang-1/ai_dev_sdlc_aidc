...
# FOSE Europe — Engelberg 2026

> 2026 年 7 月，瑞士 Engelberg。ThoughtWorks 第二场 "Future of Software Development Retreat"。
> 五个月前在 Deer Valley 还在犹豫——到 Engelberg，"证据在握"。所有人都在生产环境中交付。
...
| 文件 | 内容 | 一句话 |
|---|---|---|
| `01_event_overview.md` | 活动全景 | Deer Valley→Engelberg 五个月的变化；五条并行轨道 |
| `02_evidence_is_in.md` | "证据在握" | 从犹豫到自信；"not slides — production"；但有证据≠有共识 |
...
Engelberg 不只是 Deer Valley 的续集。它是 **agentic engineering 从实验到生产的转折点的最确切证据**。

- 五个月前 Deer Valley 还在问"这可能是什么"——Engelberg 没有人问这个问题了
- "Harness Engineering" 这个术语在 Deer Valley 时还不存在
- Token 成本、组织设计、Galaxy Brain 辩论——这些都是只有在**真正跑在生产环境中**才会浮现的问题
