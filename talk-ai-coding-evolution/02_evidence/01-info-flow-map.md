...
| P3 路线图 | 四站 | 01-opening P3 | 故事线 v1.5（自拟） |
...
| P15 抉择 | 固定 vs 灵活轴；精装公寓比喻 | 03-act3 P15；§二 P15 | 故事线 v1.5 立场（自拟） |
...
| P20 只有插件不够 | 接入 registry / 替换 adapter + seam / 放行 gate / 重建事实 session log | 04-act4 P20；§二 P20 | `rawdata_dsh-plugin-seam-maturity`；FAQ 08；`_digested` |
| P21 最终控制权 | 四项决定权；部件可借，边界自己定 | 04-act4 P21；§二 P21 | FAQ 07 / 08；`_digested`；本 talk 解释性结论 |
| P22 回答+slogan | 先借现成 / 看懂边界 / 差异化再握权 | 04-act4 P22；§一.1 | 06 角色表；本 talk 解释性结论 |
