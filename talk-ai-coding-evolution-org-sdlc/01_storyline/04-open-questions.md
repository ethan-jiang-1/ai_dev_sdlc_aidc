...
- [ ] 完成术语与视觉生产模型的最终对齐后，制作 v0.9 四张样片并等待用户视觉 REVIEW；未确认前不宣布视觉门禁通过。
...
- [ ] 当前下一步：完成最后一轮大问题对齐 → 制作并 REVIEW v0.9 的 P1/P8/P20/P42 → 写生产事实稿（`04_drafts/`）→ 建立母版并生产 50 页 PPTX（`05_output/`）。
