# ImageGen 样片 brief（v0.8 · 历史记录）

> 历史探索：本文件保留 v0.8 当时的服务入口实验与未决方案，不再指导后续生成。当前规则与资产入口见 `../CONTEXT.md`、`../CURRENT.md` 和 `experiments/imagegen-v0.13/`、`experiments/imagegen-v0.14/`。
