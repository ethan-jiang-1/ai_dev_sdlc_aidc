...
../aidlc_reference_corp/                   ← 企业与生态（兄弟目录）
...
> **本库所有内容只容许 2026 年 3 月以后的信息——即最近 3~4 个月内的材料。**

| 情况 | 处置 |
|---|---|
| **2026 年 3 月及以后** | 可放入对应 `_raw_*` 子目录（仍需满足来源铁律） |
| **2026 年 2 月及以前** | 不得入库——即使有来源也不行 |

**为什么**：AIDLC 领域变化极快。半年前的观点、框架、数据可能已被推翻。本库聚焦**当前时刻**的真实信号，不做历史档案。
...
| | `aidlc_reference_kol` | `aidlc_reference_corp` |
|---|---|---|
...
| 想知道组织/厂商的框架设计 | `../aidlc_reference_corp/_raw_aws/` + `_raw_ecosystem/` |
