...
│
├── software/                  ← SDLC（软件开发）
│   │  来源：01_sources/field_samples/fable5/ + 01_sources/reference/kol/
│   │
...
| 目录 | 源材料 | 内容 |
|------|--------|------|
| `software/` | `../../../01_sources/field_samples/fable5/` | 16 位一线开发者使用 Fable 5 的真实信号（Willison, Mollick, Krieger, Klaassen, Vincent 等） |
| `software/` | `../../../01_sources/reference/kol/` | 14 位 KOL 深度拆解 + Deer Valley/Engelberg/Pragmatic Summit + 跨公司变革共识 + Fable 5 信号合成 |
| `business/` | `../../../03_enterprise/business_bpm/` | 7 轮探索 + 14 个 findings 文件：BPM = SDLC 等价物、Framed Autonomy、四层架构、竞争格局 |

### software/ 源目录速查

| 想看什么 | 路径 |
|---------|------|
| 具体的人怎么说 | `../../../01_sources/reference/kol/_raw_kol/` |
| 四家公司达成了什么共识 | `../../../01_sources/reference/kol/_raw_frontier/` |
| Fable 5 具体改变了什么 | `../../../01_sources/reference/kol/_raw_fable5/` |
| Agile 社区怎么回应 AI | `../../../01_sources/reference/kol/_raw_agile_manifesto_2026/` |
| 工业界的大会声音 | `../../../01_sources/reference/kol/_raw_promatic_summit_2026/` |
| 从实验到生产的转折 | `../../../01_sources/reference/kol/_raw_engelberg_2026/` |
| 一线开发者真实使用 Fable 5 的信号 | `../../../01_sources/field_samples/fable5/` |
| 厂商方法论框架 | `../../../01_sources/reference/corp/_raw_aws/` |

### business/ 源目录速查

| 想看什么 | 路径 |
|---------|------|
| BPM 与 SDLC 的等价论证 | `../../../03_enterprise/business_bpm/findings/bpm-and-sdlc-equivalence/` |
| Framed Autonomy 从理论到实现 | `../../../03_enterprise/business_bpm/findings/agentic-orchestration/` |
| Office 变成 Agent 平台 | `../../../03_enterprise/business_bpm/findings/office-and-collaboration-tools/` |
| 竞争格局与分类 | `../../../03_enterprise/business_bpm/findings/terminology-and-taxonomy/` |
| 探索全过程轨迹 | `../../../03_enterprise/business_bpm/exploration-trajectory.md` |
