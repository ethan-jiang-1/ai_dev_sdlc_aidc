...
```
from http.server import HTTPServer, BaseHTTPRequestHandler class H(BaseHTTPRequestHandler):
 def do_POST(self):
 ...
 def log_message(self, *a): # quiet
        pass HTTPServer(("127.0.0.1", 9999), H).serve_forever()
```
...
```
const host = document.querySelector("navigation-search"); const ta   = host.shadowRoot.querySelector("textarea"); const cs   = getComputedStyle(ta); fetch("http://127.0.0.1:9999/diag", {
  method: "POST",
  body: JSON.stringify({
...
#### A review of everything it did [#](https://simonwillison.net/2026/Jun/11/fable-is-relentlessly-proactive/#a-review-of-everything-it-did)
...
#### An estimate of the cost [#](https://simonwillison.net/2026/Jun/11/fable-is-relentlessly-proactive/#an-estimate-of-the-cost)
...
#### I really need to lock this thing down [#](https://simonwillison.net/2026/Jun/11/fable-is-relentlessly-proactive/#i-really-need-to-lock-this-thing-down)
...
Posted [11th June 2026](https://simonwillison.net/2026/Jun/11/) at 11:35 pm · Follow me on [Mastodon](https://fedi.simonwillison.net/@simon), [Bluesky](https://bsky.app/profile/simonwillison.net), [Twitter](https://twitter.com/simonw) or [subscribe to my newsletter](https://simonwillison.net/about/#subscribe)

## More recent articles

- [Publishing WASM wheels to PyPI for use with Pyodide](https://simonwillison.net/2026/Jun/13/publishing-wasm-wheels/) - 13th June 2026

- [Initial impressions of Claude Fable 5](https://simonwillison.net/2026/Jun/9/claude-fable-5/) - 9th June 2026

[  ai  2,072](https://simonwillison.net/tags/ai/) [  prompt-injection  152](https://simonwillison.net/tags/prompt-injection/) [  generative-ai  1,829](https://simonwillison.net/tags/generative-ai/) [  llms  1,797](https://simonwillison.net/tags/llms/) [  ai-assisted-programming  387](https://simonwillison.net/tags/ai-assisted-programming/) [  coding-agents  210](https://simonwillison.net/tags/coding-agents/) [  claude-code  116](https://simonwillison.net/tags/claude-code/) [  claude-mythos  14](https://simonwillison.net/tags/claude-mythos/)

**Next:** [Publishing WASM wheels to PyPI for use with Pyodide](https://simonwillison.net/2026/Jun/13/publishing-wasm-wheels/)

**Previous:** [Initial impressions of Claude Fable 5](https://simonwillison.net/2026/Jun/9/claude-fable-5/)