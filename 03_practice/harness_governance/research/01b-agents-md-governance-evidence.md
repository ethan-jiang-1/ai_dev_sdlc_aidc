...
> 编号说明：本档案旧编号 03a（AGENTS.md 治理 03a，与渐进披露档案旧编号同为 03a、以主题区分），抽出后文件名重编为 01b；正文中"03a A/B/C/D"式引用即指本档案小节。本档案正文所称"03 文 / 03 文档"指上游 `research/01-context-engineering.md`（旧称），与 `result/backbone` 无关（2026-09-21 升格消歧）。
