...
Original Datawhale Datawhale Datawhale

_Aug 26, 2026, 10:22 PM_ _上海_
...
![封面图](figures/fig-00-cover.png)

> 插图来源：正文配图（线性流程 / 闭环 / 六阶段 / on-call）取自原文 [The AI-Native SDLC Playbook](https://claude.com/blog/the-ai-native-sdlc-playbook)，微信版原文只有懒加载占位符。
...
![线性流水线：瓶颈转移](figures/fig-01-linear-sdlc.png)
...
![闭环：标准产物在版本控制中流转](figures/fig-02-loop.png)
...
![AI-native SDLC 六阶段](figures/fig-03-six-stages.png)
...
![Claude on call：事故分流进闭环](figures/fig-04-oncall.png)
