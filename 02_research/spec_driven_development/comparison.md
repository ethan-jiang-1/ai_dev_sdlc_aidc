...
>
> ```yaml
> source: 本目录 tools/ 各深挖文档 + ../sdd-tooling-landscape-2026-09.md
...
| 项目 | Stars¹ | 创建 | 最近 release | 形态 | 硬度² | 趋势 | 主要风险 |
|---|---|---|---|---|---|---|---|
| **Superpowers** | 289k | 2025-10 | v6.4.1（09-19） | 方法论 skills 框架 | 软（行为纪律） | 强上升 | 个人主导、巴士因子、star 泡沫 |
| **GitHub Spec Kit** | 138k | 2025-08 | v1.0.8（09-17，周级） | CLI + Markdown 工件链 | 硬 | 上升 | 文字量=工作错觉、context 开销 |
...
| 场景 | 推荐 | 理由 |
|---|---|---|
| 想要大厂官方默认、生态最广（40+ agent） | **Spec Kit** | GitHub 官方维护、周级发版、TW Radar 独立条目 |
...
| 押注"代码消亡、spec 为源"的未来 | **Tessl** | 资本最重、方向最激进，风险也最大 |
...
- TW Radar 各条目的 ring 定级（Assess/Trial）因页面 JS 渲染未能提取，仅确认条目存在。
