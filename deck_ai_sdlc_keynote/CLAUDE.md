...
- **源素材**: `../aidlc_reference_kol/`（14 位 KOL + 3 场 2026 事件 + 跨公司共识 + Fable 5 信号）
...
| 想看什么 | 路径 |
|---------|------|
| 14 位 KOL 深度拆解 | `../aidlc_reference_kol/_raw_kol/` |
| 跨公司变革共识（7人） | `../aidlc_reference_kol/_raw_frontier/` |
| Fable 5 变革信号 | `../aidlc_reference_kol/_raw_fable5/` |
| Deer Valley Retreat (Feb 2026) | `../aidlc_reference_kol/_raw_agile_manifesto_2026/` |
| Pragmatic Summit (Feb 2026) | `../aidlc_reference_kol/_raw_promatic_summit_2026/` |
| Engelberg Retreat (Jul 2026) | `../aidlc_reference_kol/_raw_engelberg_2026/` |
| AWS AIDLC 方法论 | `../aidlc_reference_corp/_raw_aws/` |
| 生态全景 | `../aidlc_reference_corp/_raw_ecosystem/` |
