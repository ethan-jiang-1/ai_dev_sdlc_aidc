...
| `business/` | `../../../04_enterprise/business_bpm/` | 7 轮探索 + 14 个 findings 文件：BPM = SDLC 等价物、Framed Autonomy、四层架构、竞争格局 |
...
| 想看什么 | 路径 |
|---------|------|
| BPM 与 SDLC 的等价论证 | `../../../04_enterprise/business_bpm/findings/bpm-and-sdlc-equivalence/` |
| Framed Autonomy 从理论到实现 | `../../../04_enterprise/business_bpm/findings/agentic-orchestration/` |
| Office 变成 Agent 平台 | `../../../04_enterprise/business_bpm/findings/office-and-collaboration-tools/` |
| 竞争格局与分类 | `../../../04_enterprise/business_bpm/findings/terminology-and-taxonomy/` |
| 探索全过程轨迹 | `../../../04_enterprise/business_bpm/exploration-trajectory.md` |
