...
Claude Mythos 5 is out today as well, [Anthropic say it](https://platform.claude.com/docs/en/about-claude/models/introducing-claude-fable-5-and-claude-mythos-5) “Shares Claude Fable 5’s capabilities without the safety classifiers”. Mythos remains limited to a small pool trusted partners.

Both models have a 1 million token context window, 128,000 maximum output tokens and a knowledge cut-off date of January 2026.
...
#### The big model smell [#](https://simonwillison.net/2026/Jun/9/claude-fable-5/#the-big-model-smell)
...
## Notable projects (approximate dates) [#](https://simonwillison.net/2026/Jun/9/claude-fable-5/#notable-projects-approximate-dates-)
...
#### Using Fable in Claude.ai [#](https://simonwillison.net/2026/Jun/9/claude-fable-5/#using-fable-in-claude-ai)
...
#### Adding features to Datasette Agent and LLM using Claude Code [#](https://simonwillison.net/2026/Jun/9/claude-fable-5/#adding-features-to-datasette-agent-and-llm-using-claude-code)
...
#### How much I’ve spent [#](https://simonwillison.net/2026/Jun/9/claude-fable-5/#how-much-i-ve-spent)
...
#### And some pelicans [#](https://simonwillison.net/2026/Jun/9/claude-fable-5/#and-some-pelicans)
...
Posted [9th June 2026](https://simonwillison.net/2026/Jun/9/) at 11:59 pm · Follow me on [Mastodon](https://fedi.simonwillison.net/@simon), [Bluesky](https://bsky.app/profile/simonwillison.net), [Twitter](https://twitter.com/simonw) or [subscribe to my newsletter](https://simonwillison.net/about/#subscribe)

[  ai  2,102](https://simonwillison.net/tags/ai/) [  generative-ai  1,859](https://simonwillison.net/tags/generative-ai/) [  llms  1,826](https://simonwillison.net/tags/llms/) [  anthropic  305](https://simonwillison.net/tags/anthropic/) [  claude  288](https://simonwillison.net/tags/claude/) [  llm-pricing  80](https://simonwillison.net/tags/llm-pricing/) [  pelican-riding-a-bicycle  121](https://simonwillison.net/tags/pelican-riding-a-bicycle/) [  llm-release  210](https://simonwillison.net/tags/llm-release/) [  claude-mythos-fable  23](https://simonwillison.net/tags/claude-mythos-fable/)

**Next:** [Claude Fable is relentlessly proactive](https://simonwillison.net/2026/Jun/11/fable-is-relentlessly-proactive/)

**Previous:** [Running Python code in a sandbox with MicroPython and WASM](https://simonwillison.net/2026/Jun/6/micropython-in-a-sandbox/)